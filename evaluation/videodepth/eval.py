    ...
    for idx_model, model_keyname in enumerate(all_eval_models, start=1):
        ...
        for idx_dataset, dataset_name in enumerate(all_eval_datasets, start=1):
            ...
            if dataset_info.type == "video":
                ...
                gt_paths = {
                    seq: list_depths_a_sequence(dataset_info, seq)[::2]
                    for seq in seq_list
                }
                pred_paths = {
            ...
            for idx_seq, seq in enumerate(pred_paths, start=1):
                ...
                # depth_results, error_map, depth_predict, depth_gt = depth_evaluation(gt_depth, pr_depth, **depth_evaluation_kwargs)
