...
class Shape(object):
    ...
    def genObj(self, filePath, out_dir, bMat=False, bComputeNormal=False, bScaleMesh=False, bMaxDimRange=[0.3, 0.5], texture_path=""):
        ...
        material_ids = []
        mat = matsynth()
        mat_paths = mat.get_matsynth_material(out_dir, num_samples=20)
            ...
            for im in range(len(self.matStartId)):
                ...
                if im == 3:
                    ...
                    for material_file in material_files:
                        src_path = os.path.join(texture_path, material_file)
...
class matsynth:
    def __init__(self):
        ...
        self.ds = self.ds.select_columns(mat_keys)

    def get_matsynth_material(self, base_output_dir, num_samples=1):
