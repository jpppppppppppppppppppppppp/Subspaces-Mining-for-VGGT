...
class Shape(object):
    ...
    def genObj(self, filePath, out_dir, bMat=False, bComputeNormal=False, bScaleMesh=False, bMaxDimRange=[0.3, 0.5], group_id=0):
        ...
        material_ids = []
        mat = matsynth()
        mat_paths = mat.get_matsynth_material(os.path.join(out_dir, "..", "materials"), num_samples=20, group_id=group_id)
...
class matsynth:
    cached_output = []
    def __init__(self):
        self.base_dir = "YOUR_MATERIALS_PATH"
        self.ds = sorted(os.listdir(self.base_dir))

    def get_matsynth_material(self, base_output_dir, num_samples=1, group_id=0):
