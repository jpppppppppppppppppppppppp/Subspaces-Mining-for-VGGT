    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        *,
        ...
        kwargs = {
            ...
            "apply_svd_lora": lora_config.apply_svd_lora,
            "pattern_svd_lora": lora_config.pattern_svd_lora,
            "use_predefined_space": lora_config.use_predefined_space,
    ...
    def _mark_only_adapters_as_trainable(self, model: nn.Module) -> None:
        for n, p in model.named_parameters():
            ...
            if "lora_A.default.0.weight" in n:
                p.requires_grad = False
            if "lora_B.default.1.weight" in n:
                p.requires_grad = False
