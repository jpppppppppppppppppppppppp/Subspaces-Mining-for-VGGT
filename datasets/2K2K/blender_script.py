    ...
    if object_path.endswith(".glb"):
        ...
        if obj.type == 'MESH':
            ...
            if mesh.vertex_colors:
                ...
                vertex_color_node.attribute_name = vertex_color_layer.name
                mat.node_tree.links.new(vertex_color_node.outputs["Color"], color_input)
...
def save_images(object_file: str) -> None:
    ...
    env_light = stable_uid_to_env_light(int(subject_id))
